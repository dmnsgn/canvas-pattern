...
_export({ target: 'Map', proto: true, real: true, forced: isPure }, {
  update: function update(key, callback /* , thunk */) {
    ...
    if (!isPresentInMap && length < 3) {
      throw TypeError$c('Updating absent value');
    }
      ...
      var loop = function () {
        try {
          if (IS_TO_ARRAY && (index > MAX_SAFE_INTEGER) && MAPPING) {
            throw TypeError$f('The allowed number of iterations has been exceeded');
          }
...
export { createNonEnumerableProperty as $, getBuiltIn as A, createIteratorConstructor as B, redefineAll as C, redefine as D, setToStringTag as E, isCallable as F, anInstance as G, isObject as H, anObject as I, hasOwnProperty_1 as J, classof as K, objectCreate as L, objectDefineProperties as M, classofRaw as N, toIndexedObject as O, objectGetOwnPropertyNames as P, sharedKey as Q, shared as R, nativeSymbol as S, objectIsPrototypeOf as T, uid as U, objectGetOwnPropertyDescriptor as V, hiddenKeys as W, isSymbol as X, functionApply as Y, copyConstructorProperties as Z, _export as _, isPure as a, objectSetPrototypeOf as a0, objectGetPrototypeOf as a1, iterate as a2, addToUnscopables as a3, toIntegerOrInfinity as a4, engineV8Version as a5, toAbsoluteIndex as a6, aCallable as a7, arrayIncludes as a8, engineUserAgent as a9, collectionDeleteAll as aA, mapEmplace as aB, domIterables as aC, domTokenListPrototype as aD, getDefaultExportFromCjs as aE, commonjsGlobal as aF, toLength as aa, functionName as ab, tryToString as ac, speciesConstructor as ad, requireObjectCoercible as ae, toPrimitive as af, ordinaryToPrimitive as ag, createCommonjsModule as ah, isForced_1 as ai, ownKeys as aj, correctPrototypeGetter as ak, toStringTagSupport as al, documentCreateElement as am, html as an, inspectSource as ao, aConstructor as ap, aPossiblePrototype as aq, getMethod as ar, es_array_iterator as as, nativeWeakMap as at, asyncIteratorPrototype as au, asyncIteratorIteration as av, asyncIteratorCreateProxy as aw, iteratorCreateProxy as ax, iteratorClose as ay, iteratorsCore as az, functionUncurryThis as b, toObject as c, defineIterator as d, indexedObject as e, fails as f, descriptors as g, functionCall as h, internalState as i, objectGetOwnPropertySymbols as j, objectPropertyIsEnumerable as k, toPropertyKey as l, objectDefineProperty as m, createPropertyDescriptor as n, objectKeys as o, global_1 as p, isConstructor as q, functionBindContext as r, stringMultibyte as s, toString_1 as t, getIteratorMethod as u, isArrayIteratorMethod as v, wellKnownSymbol as w, getIterator as x, callWithSafeIterationClosing as y, lengthOfArrayLike as z };
